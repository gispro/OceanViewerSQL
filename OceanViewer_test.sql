--SELECT admin.ov_print('''Hello''');
--SELECT admin.ov_curl('http://gis.esimo.net:8080');
--SELECT admin.ov_curl('http://www.yandex.ru', '-XPOST -H ''Content-type: text/xml''');
...
--SELECT admin.ov_psql('SELECT admin.ov_createResource(''123'', ''RU_Hydrometcentre_60'', ''p0239_00'', ''ln'')');

--SELECT admin.ov_initPlPerl();
--SELECT admin.ov_loginJOSSO();
--SELECT admin.ov_isLoggedInJOSSO();
--SELECT admin.ov_reloadGeoserverNodes();
--SELECT admin.ov_pushInQueue('128', 'RU_Hydrometcentre_46_1', 'createPoints');
--SELECT admin.ov_popFromQueue('123', 'RU_Hydrometcentre_46_1');
...
--SELECT admin.ov_wmsCatalogCheck('', 'RU_Hydrometcentre_46_1', '', 'pt');

--SELECT admin.ov_getSchema('RU_Hydrometcentre_46_1');
...
--SELECT admin.ov_addGeometryColumn('123', 'RU_Hydrometcentre_42_3');
--SELECT admin.ov_addPrimaryKey('123', 'RU_Hydrometcentre_42_3');
--SELECT admin.ov_createMask('RU_Hydrometcentre_46_1');
--SELECT admin.ov_createWorkspace('RU_Hydrometcentre_60');
--SELECT admin.ov_removeWorkspace('RU_Hydrometcentre_60');

--Public API

--SELECT admin.ov_processResource('', 'RU_Hydrometcentre_60', 'p0239_00', 'ln');
...
--SELECT admin.ov_createResource('123', 'RU_Hydrometcentre_60', 'p0239_00', 'pt');
